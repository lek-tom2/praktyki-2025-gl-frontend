    ...
    <PageTemplate>
      <div className='w-[85%] ml-[10%] mr-[10%] h-[15%] mt-4 flex flex-row gap-4'>
        <div className="flex flex-col w-[60%]">
          <p className='text-left text-[#ffffff] text-xs mb-1'>{t("parkingDisplay.destination")}</p>
          <Input
            className='bg-[#333446] rounded-xl h-[50%] w-[100%]'
            type="text"
            name="destination"
            placeholder={t("parkingDisplay.destination")}
          />
        </div>

        <div className="flex flex-col w-[20%]">
          <p className='text-left text-[#ffffff] text-xs mb-1'>{t("parkingDisplay.checkin")}</p>
          <Input
            className='bg-[#333446] rounded-xl h-[50%] w-[100%]'
            type="date"
        ...
        <div className="flex flex-col w-[20%]">
          <p className='text-left text-[#ffffff] text-xs mb-1'>{t("parkingDisplay.checkout")}</p>
          <Input
            className='bg-[#333446] rounded-xl h-[50%] w-[100%]'
            type="date"
            placeholder='yyyy-mm-dd'
      ...
      <div className="flex flex-row w-[85%] ml-[10%] gap-4  mb-10">
        <div className="flex flex-col justify-center w-[35%] text-left text-white gap-4">
          ...
          <Button
            customWidth='100%'
            type='button'
            value={t("reservation.createReservation") || "Create Reservation"}
            hoverEffect={true}
          />
        </div>

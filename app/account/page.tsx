...
<header className = "w-full max-w-4xl mx-auto p-8"  > {/* all account management div*/}
    <h1 className="text-4xl font-bold  text-base-content justify-start">Account Management</h1>
...
<section className="grid grid-cols-2 gap-x-8 gap-y-4">
    ...
    <div className="flex flex-col gap-y-2">
      ...
      <input type="text" className="text-base-content bg-primary rounded-[0.25rem] h-10"  />
    </div>
    <div className="flex flex-col gap-y-2">

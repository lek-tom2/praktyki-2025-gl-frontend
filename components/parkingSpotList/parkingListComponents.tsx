...
export const ParkingSpotEntry = ({
  ...
  return (
    <Link href={`/parking-spaces/${parkingSpot.id}`} className="select-none">
      <div
        className={`flex flex-row items-center gap-6 w-[95%] bg-base-200 min-h-20 text-primary-content rounded-2xl shadow-[0_4px_4px_rgba(0,0,0,0.25)] border-l-2 border-r-2 hover:scale-101 duration-300 ml-4 mr-4 ${
      ...
      >
        ...
        <div className="text-base-content">{parkingSpot.name}</div>
        <div
          className={`${
            parkingSpot.aviability === "occupied"
              ? "text-rose-800"

  ...
  return (
    <nav className="bg-secondary h-16 w-full flex flex-row items-center justify-start text-neutral px-6">
      ...
      <div className="flex flex-row items-center justify-between w-[9vw] mr-30 ml-auto text-[12px] ">
        <Link
          href="login-register"
          className="flex bg-info items-center font-semibold justify-center rounded-4xl w-[50%] text-center h-8 bg-base-300 ml-[-1rem] min-w-6 hover:scale-105 duration-300"
        >
          Login
        </Link>
        <Link
          href="login-register"
          className="flex bg-info items-center font-semibold justify-center rounded-4xl w-[50%] text-center h-8 bg-base-300 min-w-6 hover:scale-105 duration-300"
        >
          Sign Up
        </Link>
      </div>
